...
if __name__ == '__main__':
    ...
    test = Hoovercraft()
    test.muta_init("Hoovercraft instance #2")
    print("Make sure that mutaprops master (e.g. advanced_example.py) "
          "is running on port 9000. In case of running both master and slave "
          "on separate machines, make sure this instance is run with publicly"
          "identifiable host (no 'localhost' or '0.0.0.0')")
    man = HttpMutaManager("Hoovercraft slave manager", proxy_log=logger,
